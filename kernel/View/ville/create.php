<h1>Ajouter d'une ville</h1>
<?php

    $path = WEBROOT."ville/insert/";

    echo  '<form action="'.$path.'" method="POST">
    <label>Code Postal : </label>
    <input class="inp" type="text" id="vil_cp" name="vil_cp" />
    <span class="error" id="cpError"></span><br/>
    <br/>
    <label>  Nom ville : </label>
    <input class="inp" id="vil_libelle" type="text" name="vil_libelle"/>
